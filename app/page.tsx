      ...
      <section className="py-24 bg-surface">
        <div className="max-w-container-max mx-auto px-margin-desktop max-md:px-margin-mobile">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            <div className="col-span-1 md:col-span-5 relative fade-in-up stagger-2">
            ...
            <div className="col-span-1 md:col-span-5 flex flex-col gap-stack-md fade-in-up stagger-3">
        ...
        <div className="max-w-container-max mx-auto px-margin-desktop max-md:px-margin-mobile">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
            <Link
              ...
              className="md:col-span-2 relative rounded-xl overflow-hidden group ambient-shadow bg-surface cursor-pointer fade-in-up stagger-1"
            >
              <Image
                fill
            ...
            {services.slice(1).map((service, index) => (
              <Link
                ...
                className={`relative rounded-xl overflow-hidden group ambient-shadow bg-surface cursor-pointer fade-in-up stagger-${((index + 1) % 3) + 1}`}
              >
                <Image
                  fill
                  alt={service.title}
          ...
          <div className="mt-6 relative rounded-xl overflow-hidden flex items-center justify-center p-12 bg-primary-fixed-dim ambient-shadow fade-in-up">
